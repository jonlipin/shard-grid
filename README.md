...
- **Animated:** a purple star of light bursts in the middle of the screen and a new shard is thrown out of it, lobbing up and back down into its slot while it tumbles, grows and trails purple light. A spent one bursts with the same star and flashes out. A small click sounds as a shard settles. All of it can be turned off.
