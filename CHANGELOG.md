...
- Shards are tossed into the grid when you gain one: a purple light bursts somewhere in the middle of the screen, in a different spot each time, and the shard is thrown out of it, lobbing up and back down into its slot over about a second, growing as it goes and tumbling in the direction it travels. A spent shard flashes out of its slot. This can be turned off.
