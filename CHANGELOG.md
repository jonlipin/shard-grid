...
- A shard flying into the grid arrives its own color and takes on the orange or red during the second half of its flight, so you watch it go wrong rather than simply appear wrong.
